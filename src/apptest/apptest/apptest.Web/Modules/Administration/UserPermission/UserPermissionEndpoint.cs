using MyRepository = apptest.Administration.Repositories.UserPermissionRepository;
using MyRow = apptest.Administration.UserPermissionRow;

namespace apptest.Administration.Endpoints;
